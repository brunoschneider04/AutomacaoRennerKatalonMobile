...
<MobileElementEntity>
   ...
   <name>android.widget.Button - FINALIZAR PEDIDO (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'FINALIZAR PEDIDO' or . = 'FINALIZAR PEDIDO') and @resource-id = 'br.com.lojasrenner:id/checkout_payment_finish']</locator>
