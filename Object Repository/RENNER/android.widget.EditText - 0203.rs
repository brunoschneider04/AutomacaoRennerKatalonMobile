...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - 0203</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '02/03' or . = '02/03') and @resource-id = 'br.com.lojasrenner:id/card_payments_expiration_date_view']</locator>
