...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - 0322</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '03/22' or . = '03/22') and @resource-id = 'br.com.lojasrenner:id/card_payments_expiration_date_view']</locator>
