...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - 0430</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '04/30' or . = '04/30') and @resource-id = 'br.com.lojasrenner:id/card_payments_expiration_date_view']</locator>
