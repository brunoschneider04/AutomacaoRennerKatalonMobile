...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Nmero do carto (12)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Número do cartão' or . = 'Número do cartão') and @resource-id = 'br.com.lojasrenner:id/payment_method_card_number_view']</locator>
