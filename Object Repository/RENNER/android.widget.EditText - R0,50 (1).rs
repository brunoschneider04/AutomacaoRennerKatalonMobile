...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - R0,50 (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'R$ 0,50' or . = 'R$ 0,50') and @resource-id = 'br.com.lojasrenner:id/value_dialog_selected_value']</locator>
