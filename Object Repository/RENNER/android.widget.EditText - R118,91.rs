...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - R118,91</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'R$ 118,91' or . = 'R$ 118,91') and @resource-id = 'br.com.lojasrenner:id/value_dialog_selected_value']</locator>
