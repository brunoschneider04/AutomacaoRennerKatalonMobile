...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - R139,90 (4)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'R$ 139,90' or . = 'R$ 139,90') and @resource-id = 'br.com.lojasrenner:id/value_dialog_selected_value']</locator>
