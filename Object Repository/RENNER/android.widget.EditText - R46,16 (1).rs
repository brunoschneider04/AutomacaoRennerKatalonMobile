...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - R46,16 (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'R$ 46,16' or . = 'R$ 46,16') and @resource-id = 'br.com.lojasrenner:id/value_dialog_selected_value']</locator>
