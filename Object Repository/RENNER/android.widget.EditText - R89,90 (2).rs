...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - R89,90 (2)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'R$ 89,90' or . = 'R$ 89,90') and @resource-id = 'br.com.lojasrenner:id/value_dialog_selected_value']</locator>
