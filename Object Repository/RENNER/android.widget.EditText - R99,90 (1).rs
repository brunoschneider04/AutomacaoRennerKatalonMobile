...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - R99,90 (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'R$ 99,90' or . = 'R$ 99,90') and @resource-id = 'br.com.lojasrenner:id/value_dialog_selected_value']</locator>
