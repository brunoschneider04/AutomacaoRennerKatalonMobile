...
<MobileElementEntity>
   ...
   <name>android.widget.RadioButton (15)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.RadioButton' and @resource-id = 'br.com.lojasrenner:id/checkout_shipping_selector' and (@text = '' or . = '')]</locator>
