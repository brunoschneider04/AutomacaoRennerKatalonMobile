...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Fazer logout (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Fazer logout' or . = 'Fazer logout') and @resource-id = 'br.com.lojasrenner:id/menu_login_status']</locator>
