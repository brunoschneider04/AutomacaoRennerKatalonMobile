...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Masculino (12)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Masculino' or . = 'Masculino') and @resource-id = 'br.com.lojasrenner:id/appBar_title']</locator>
