...
//1 click com meu cartão já deve estar ativado
...
Mobile.tap(findTestObject('Object Repository/RENNER/android.widget.Button - IR PARA PAGAMENTO (7)'),30)

Mobile.setText(findTestObject('Object Repository/RENNER/android.widget.EditText - Cd. de Segurana'), '238', 30)

Mobile.getText(findTestObject('Object Repository/RENNER/android.widget.TextView - Pagamento comMeu Carto'), 30)

Mobile.tap(findTestObject('Object Repository/RENNER/android.widget.ImageButton (4)'), 30)

Mobile.tap(findTestObject('Object Repository/RENNER/android.widget.EditText - 4745 25  3348'), 30)
