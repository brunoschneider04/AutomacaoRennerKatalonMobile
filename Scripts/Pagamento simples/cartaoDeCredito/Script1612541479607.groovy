...
Mobile.swipe(900, 600, 600, 600)

Mobile.tap(findTestObject('Object Repository/RENNER/android.widget.TextView - Carto de Crdito (1)'), 30)

Mobile.setText(findTestObject('Object Repository/RENNER/android.widget.EditText - Nmero do carto (6)'), '5390437226518927', 
    30)

Mobile.setText(findTestObject('Object Repository/RENNER/android.widget.EditText - Nome impresso no carto'), 'Pam', 30)

Mobile.setText(findTestObject('Object Repository/RENNER/android.widget.EditText - Cd. de Segurana (1)'), '471', 30)

Mobile.setText(findTestObject('Object Repository/RENNER/android.widget.EditText - Venc. (mmaa) (2)'), '0322', 30)

Mobile.tap(findTestObject('Object Repository/RENNER/android.widget.ImageButton (6)'), 30)

Mobile.tap(findTestObject('Object Repository/RENNER/android.view.ViewGroup (15)'), 30)

Mobile.tap(findTestObject('Object Repository/RENNER/android.widget.Button - PRONTO (4)'), 30)
